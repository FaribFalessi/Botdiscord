...
const token = 'MTMzNDYwMTc0MDQ0NzkwNzk2Mg.GUvgLL.KXpTviESokPN7eXJlQQFaUe6yDbJ1pkRKujWJM';
...
client.once('ready', () => {
    ...
    const eventos = [
        ...
        { inicio: 7, duracion: 3, tipo: 'MISIÓN DE TRÁFICO ILEGAL', dias: '1,4,6' },
        { inicio: 15, duracion: 3, tipo: 'MISIÓN DE TRÁFICO ILEGAL', dias: '1,4,6' },
        { inicio: 20, duracion: 1, tipo: 'MISIÓN DE TRÁFICO ILEGAL', dias: '1,4,6' },
        { inicio: 22, duracion: 12, tipo: 'ROBO A NEGOCIO', dias: '0,1,2,3,4,5,6' },
        { inicio: 0, duracion: 2, tipo: 'LANCHA ENCALLADA', dias: '0,1,2,3,4,5,6' },
        { inicio: 14, duracion: 2, tipo: 'LANCHA ENCALLADA', dias: '0,1,2,3,4,5,6' },
        { inicio: 16, duracion: 2, tipo: 'LANCHA ENCALLADA', dias: '0,1,2,3,4,5,6' },
        { inicio: 18, duracion: 2, tipo: 'LANCHA ENCALLADA', dias: '0,1,2,3,4,5,6' },
        { inicio: 5, duracion: 16, tipo: 'ELABORACIÓN DE METANFETAMINA (DÍA 1)', dias: '1' }, // Lunes, de 05:00 a 21:00
        { inicio: 5, duracion: 16, tipo: 'ELABORACIÓN DE METANFETAMINA (DÍA 2)', dias: '3' }, // Miércoles, de 05:00 a 21:00
        { inicio: 5, duracion: 16, tipo: 'ELABORACIÓN DE METANFETAMINA (DÍA 3)', dias: '5' }, // Viernes, de 05:00 a 21:00
        ...
        { inicio: 0, duracion: 2, tipo: 'BUSQUEDA DE CONTENEDORES', dias: '3,4,6,0' }, // Miércoles, jueves, sábado, domingo, de 00:00 a 02:00
        { inicio: 16, duracion: 2, tipo: 'BUSQUEDA DE CONTENEDORES', dias: '3,4,6,0' }, // Miércoles, jueves, sábado, domingo, de 16:00 a 18:00
        { inicio: 18, duracion: 2, tipo: 'BUSQUEDA DE CONTENEDORES', dias: '3,4,6,0' }, // Miércoles, jueves, sábado, domingo, de 18:00 a 20:00
        { inicio: 20, duracion: 1, tipo: 'BUSQUEDA DE CONTENEDORES', dias: '3,4,6,0' } // Miércoles, jueves, sábado, domingo, de 20:00 a 21:00
    ];

    eventos.forEach(evento => {
        cron.schedule(`0 ${evento.inicio} * * ${evento.dias}`, () => {
...
client.on('messageCreate', async (message) => {
    ...
    if (message.content.toLowerCase() === '!tester elaboracion de metanfetamina') {
        console.log('🛠️ Probando evento "ELABORACIÓN DE METANFETAMINA (DÍA 1)"...');
        await iniciarRecordatorios(16, 'ELABORACIÓN DE METANFETAMINA (DÍA 1)');
    }
    if (message.content.toLowerCase() === '!tester elaboracion de metanfetamina dia 2') {
        console.log('🛠️ Probando evento "ELABORACIÓN DE METANFETAMINA (DÍA 2)"...');
        await iniciarRecordatorios(16, 'ELABORACIÓN DE METANFETAMINA (DÍA 2)');
    }
    if (message.content.toLowerCase() === '!tester elaboracion de metanfetamina dia 3') {
        console.log('🛠️ Probando evento "ELABORACIÓN DE METANFETAMINA (DÍA 3)"...');
...
async function enviarMensaje(channel, tipo, esRecordatorio = false) {
    ...
    if (tipo === 'ROBO A VEHÍCULO') {
        embed = new EmbedBuilder()
            ...
            .addFields(
                { name: "🛠️ Requisitos", value: "**- Destornillador**", inline: true }
            )
            .setColor(0xff0000)
        ...
        embed = new EmbedBuilder()
            ...
            .setDescription("**🟡 BÚSQUEDA DE CONTENEDORES EN CURSO**\n\n 🚢 ¡Busca los contenedores esparcidos por la ciudad!")
            .addFields(
                { name: "🛠️ Requisitos", value: "**- Taladro**", inline: true }
            )
            .setColor(0xff0000)
    ...
    // Enviar el mensaje
    lastMessages[tipo] = await channel.send({ content: esRecordatorio ? '🔔 **Recordatorio**: ¡El evento sigue activo! No olvides guardar la toma fotográfica. 📷' : '📢 **Aviso para <@&1334408903034667029>**!', embeds: [embed] });
